<%@ Page Language="C#" MasterPageFile="~/m_MasterPage_PostBackBreak.master" AutoEventWireup="true" CodeFile="m_RES_Resign.aspx.cs" Inherits="Resource_m_RES_Resign" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript">
        // 퇴사일(YYYYMMDD)의 유효성을 체크하고 표준 날자 포맷(YYYY-MM-DD)으로 변환하여 리턴
        function CheckRetireDate() {
            if (document.getElementById('<%= this.txtRES_RetireDate.ClientID %>').value == "YYYYMMDD") {
                alert("퇴사일을 입력해 주세요.");
                document.getElementById('<%= this.txtRES_RetireDate.ClientID %>').focus();
                return false;
            }

            var num, year, month, day;
            num = document.getElementById('<%= this.txtRES_RetireDate.ClientID %>').value;
            ...
            if (isNaN(num)) {
                ...
                if (num != 0 && num.length == 8) {
                    ...
                    num = "";
                    alert("퇴사일 입력 형식은 YYYYMMDD 입니다.");
                    document.getElementById('<%= this.txtRES_RetireDate.ClientID %>').focus();
                    return false;
                }

                document.getElementById('<%= this.txtRES_RetireDate.ClientID %>').value = num;
            }
        }
    ...
    <div class="title">
        <h2 class="mepm_title">사원 관리 > 퇴사 요청</h2>
    </div>
    <article style="padding-bottom: 1em;">
        <section>
                ...
                <table>
                    <tr class="mepm_menu_title_bg" style="height: 3em;">
                        ...
                        <td style="width:auto; text-align: left; padding-right:.8em;">
                            <asp:Label id="lblRES_Number" width="100%" runat="server" Font-Size=".85em" Font-Bold="true"></asp:Label>
                        </td>
                    </tr>
                    <tr class="mepm_menu_item_bg" style="height: 3em;">
                        <td style="border-top: 1px solid #ccc;"rowspan="4" align="center" valign="middle">
                    ...
                    <tr class="mepm_menu_item_bg" style="height: 3em;">
                        ...
                        <td style="border-top: 1px solid #ccc; text-align: left; padding-right: .8em;">
                            <asp:Label id="lblRES_CP" width="100%" runat="server" Font-Size=".85em"></asp:Label>
                        </td>
                    </tr>
                    <tr class="mepm_menu_item_bg" style="height: 3em;">
                        <th style="border-top: 1px solid #ccc; border-left: 1px solid #ccc;">
                        ...
                        <td style="border-top: 1px solid #ccc; text-align: left; padding-right: .8em;">
                            <asp:Label id="lblRES_JoinDate" width="100%" runat="server" Font-Size=".85em"></asp:Label>
                        </td>
                    </tr>
                </table>
                <table>
                    <tr class="mepm_menu_item_bg" style="height: 3em;">
                        ...
                        <td style="border-top: 1px solid #ccc; text-align: left; padding-right: .8em;">
                            <asp:Textbox id="txtRES_RetireDate" width="100%" runat="server" value="YYYYMMDD" onfocus="change(this,'YYYYMMDD')" onblur="change(this,'YYYYMMDD')" class="i_f_out2"></asp:Textbox>
                        </td>
                    </tr>
                    <tr class="mepm_menu_item_bg" style="height: 3em;">
                        <th style="border-top: 1px solid #ccc; width:70px;">
                            퇴사사유 :
                        </th>
                        <td style="border-top: 1px solid #ccc; text-align: left; padding-right: .8em;">
            ...
            <div class="mepm_btn_div">
                <asp:Button CssClass="button gray mepm_asp_btn" Text="퇴사요청" ID="btnRetire" 
                                    runat="server" OnClientClick="javascript:return fncChkSave();" OnClick="btnRetire_Click" />
