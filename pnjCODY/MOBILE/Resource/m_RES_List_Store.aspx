<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_RES_List_Store.aspx.cs" Inherits="Resource_m_RES_List_Store" %>
    ...
    <article style="padding-bottom: 1em;">
        <section>
            <table class="mepm_icon_title">
                    <tr>
                        <td style="width:100%;"><p ><asp:Label runat="server" ID="STORE_NAME" Text=""></asp:Label> 사원 목록</p></td>
                    </tr>
                </table>
             <div class="mepm_menu_item" style="padding:0;">
                    <asp:GridView ID="gvResList" runat="server" CellPadding="0"  Width="100%"  EmptyDataText="일치하는 정보가 없습니다." ShowHeaderWhenEmpty="True"
                        ...
                        <Columns>
                            ...
                            <asp:boundfield HeaderText="지원사" DataField="RES_VENDER_NAME">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border"/>
						    </asp:boundfield>
                            ...
                            <asp:boundfield HeaderText="출근현황" DataField="ATT_DAY_Icon">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border"/>
						    </asp:boundfield>
                        </Columns>
