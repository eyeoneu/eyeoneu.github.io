...
public partial class Resource_m_RES_List : System.Web.UI.Page
{
    ...
    private void SetgvResList()
    {
        if (Session["sRES_ID"] != null)
            ...
            DataSet ds = resource.EPM_RES_LIST_MOBILE(this.Page.Request["NAME"], this.Page.Request["RES_WORKGROUP1"], Session["sRES_RBS_CD"].ToString(), Session["sRES_RBS_AREA_CD"].ToString(), this.Page.Request["BIRTH"]);
