...
public partial class m_BUS_Approval_List : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("/Business/m_BUS_Approval_Report.aspx?APP_ID=" + this.hdAPP_ID.Value.ToString());
    }
    ...
    private DataTable Select_Market_List()
    {
        ...
        SqlDataAdapter ad = new SqlDataAdapter("EPM_APPROVAL_LIST_MOBILE", Con);
