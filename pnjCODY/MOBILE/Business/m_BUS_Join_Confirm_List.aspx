<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_BUS_Join_Confirm_List.aspx.cs" Inherits="m_BUS_Join_Confirm_List" %>
        ...
        <section>
            ...
            <div class="mepm_menu_item_bg" style="padding:0; border-bottom:1px solid #ccc;">
             ...
             <div class="mepm_menu_item" style="padding:0;">
                    <asp:GridView ID="gvList" runat="server" CellPadding="0"  Width="100%"  EmptyDataText="일치하는 정보가 없습니다." ShowHeaderWhenEmpty="True"
                         CssClass="table_border" OnRowDataBound="gvResList_RowDataBound" AutoGenerateColumns="false">
                        <Columns>
                            <asp:boundfield HeaderText="작성일" DataField="CREATED_DATE">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border" />
						    </asp:boundfield>
                            <asp:boundfield HeaderText="대상자" DataField="APP_Name">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border"/>
						    </asp:boundfield>
                            <asp:boundfield HeaderText="주민번호" DataField="APP_PersonNumber">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border" />
						    </asp:boundfield>
            ...
            <div class="mepm_btn_div">
                <a href="/Business/m_BUS_Join_Confirm_Report.aspx?APP_ID=0"><span class="button gray mepm_btn">입력</span></a>
