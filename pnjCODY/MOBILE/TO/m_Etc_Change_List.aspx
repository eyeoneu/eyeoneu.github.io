<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_Etc_Change_List.aspx.cs" Inherits="m_Etc_Change_List" %>
...
//            location.href("/Resource/m_RES_Mng.aspx?" + encodeURI(parm.join('&')));
    ...
    <div class="title">
        <h2 class="mepm_title">업무 연락 > 기타변경</h2>
    </div>
    <article style="padding-bottom: 1em;">
        <section>
            <table class="mepm_icon_title">
                    <tr>
                        <td style="width:90%;"><p >기타변경 목록</p></td>
            ...
            <div class="mepm_btn_div">
                <a href="/TO/m_Etc_Change.aspx?RES_ID=<%= this.Page.Request["RES_ID"]%>"><span class="button gray mepm_btn">입력</span></a>
