...
public partial class m_To_Round_Change_List : System.Web.UI.Page
{
    ...
    private DataTable Select_Trn_List()
    {
        ...
        SqlDataAdapter ad = new SqlDataAdapter("EPM_TO_ROUND_HISTORY_LIST_MOBILE", Con);
        ad.SelectCommand.CommandType = CommandType.StoredProcedure;

        ad.SelectCommand.Parameters.AddWithValue("@GB", "R");
