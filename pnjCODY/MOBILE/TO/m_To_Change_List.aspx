<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_To_Change_List.aspx.cs" Inherits="m_To_Change_List" %>
...
//            location.href("/Resource/m_RES_Mng.aspx?" + encodeURI(parm.join('&')));
    ...
    <div class="title">
        <h2 class="mepm_title">기타 업무 관리 > TO변경</h2>
    </div>
    <article style="padding-bottom: 1em;">
        <section>
            <table class="mepm_icon_title">
                    <tr>
                        <td style="width:90%;"><p >TO변경 목록</p></td>
            ...
            <div class="mepm_btn_div">
                <a href="/TO/m_To_Change.aspx?RES_ID=<%= this.Page.Request["RES_ID"]%>"><span class="button gray mepm_btn">입력</span></a>
