<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_To_Round_Change_List.aspx.cs" Inherits="m_To_Round_Change_List" %>
    ...
    <article style="padding-bottom: 1em;">
        <section>
            <table class="mepm_icon_title">
                    <tr>
                        <td style="width:90%;"><p >순회/격고 매장 변경 목록</p></td>
            ...
            <div class="mepm_btn_div">
                <a href="/TO/m_To_Round_Change.aspx?RES_ID=<%= this.Page.Request["RES_ID"]%>"><span class="button gray mepm_btn">입력</span></a>
