...
public partial class Attendance_m_ATT_Parttime_Request_Modify : System.Web.UI.Page
{
	...
	protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            attendance.EPM_ATT_BY_DAY_ITEM_REQUEST_MOBILE("M", int.Parse(this.Page.Request["ATT_DAY_ID"].ToString()), this.ddlRES_CON_TIME.SelectedValue.ToString(), this.rdoATT_DAY_Code.SelectedValue.ToString(), this.txtAttRequest.Text.ToString(), Session["sRES_RBS_CD"].ToString(), Session["sRES_RBS_AREA_CD"].ToString(), int.Parse(Session["sRES_ID"].ToString()));
