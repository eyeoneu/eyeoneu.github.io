<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_ATT_Closed_Leave_Mng.aspx.cs" Inherits="Attendance_m_ATT_Closed_Leave_Mng" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript">
        ...
        function fncDetail(strATT_REQ_ID){
            document.getElementById('<%= this.hdATT_REQ_ID.ClientID %>').value =  strATT_REQ_ID;

            <%= Page.GetPostBackEventReference(this.btnDetail) %>    
        }
    </script>
    <input type="hidden" id="hdATT_REQ_ID" name="hdATT_REQ_ID" runat="server" />
    ...
    <div class="title">
        <h2 class="mepm_title">연차 신청서 관리</h2>
    </div>
    <article style="padding-bottom: 1em;">
        <section>
            <table class="mepm_icon_title">
                    <tr>
                        <td style="width:100%;"><p >연차 신청서 관리</p></td>
                    </tr>
                </table>
             <div class="mepm_menu_item" style="padding:0;">
                <table>
                    <tr class="mepm_menu_item_bg" style="height: 3em;">
                        <td style="width:45px;text-align:left; padding-left:.5em;">
                            기간 :
                        </td>
                        <td style="width:auto; text-align:left;" colspan="3">
                    ...
                    <asp:GridView ID="gvReqList" runat="server" CellPadding="0"  Width="100%"  EmptyDataText="등록된 신청서가 없습니다." ShowHeaderWhenEmpty="True"
                        ...
                        <Columns>
                            ...
                            <asp:boundfield HeaderText="항목" DataField="ATT_REQ_TYPE">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border"/>
						    </asp:boundfield>
                            <asp:boundfield HeaderText="작성일" DataField="ATT_REQ_WriteDate">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border"/>
						    </asp:boundfield>
                            <asp:boundfield HeaderText="상태" DataField="REQ_STATUS">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border"/>
						    </asp:boundfield>
                        </Columns>
