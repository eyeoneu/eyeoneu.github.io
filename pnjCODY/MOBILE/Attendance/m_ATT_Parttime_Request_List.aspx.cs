...
public partial class Attendance_m_ATT_Parttime_Request_List : System.Web.UI.Page
{
    ...
    private void SetList()
    {
        ...
        {
            Attendance attendance = new Attendance();
            DataSet ds = attendance.EPM_ATT_DAY_REQ_TODAY_LIST("CON", Session["sRES_RBS_CD"].ToString(), Session["sRES_RBS_AREA_CD"].ToString(), this.hdDate.Value.ToString());
