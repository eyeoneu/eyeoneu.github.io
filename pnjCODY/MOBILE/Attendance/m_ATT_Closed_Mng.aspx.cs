...
public partial class Attendance_m_ATT_Closed_Mng : System.Web.UI.Page
{
    ...
    private void SetList()
    {
        if (Session["sRES_ID"] != null)
        {
            ...
            DataSet ds = attendance.EPM_ATT_REQ_LIST_MOBILE(int.Parse(Session["sRES_ID"].ToString()), this.txtFROMDATE.Text.ToString(), this.txtTODATE.Text.ToString());
    ...
    {
        Response.Redirect("/Attendance/m_ATT_Closed_Request.aspx?ATT_REQ_ID=" + this.hdATT_REQ_ID.Value.ToString());
    }
}