<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_ATT_Closed_Mng.aspx.cs" Inherits="Attendance_m_ATT_Closed_Mng" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">
        <h2 class="mepm_title">휴무 신청서 관리</h2>
    </div>
    <article style="padding-bottom: 1em;">
        <section>
            <table class="mepm_icon_title">
                    <tr>
                        <td style="width:100%;"><p >휴무 신청서 관리</p></td>
                    </tr>
                </table>
