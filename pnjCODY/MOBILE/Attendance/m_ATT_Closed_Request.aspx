<%@ Page Language="C#" MasterPageFile="~/m_MasterPage_PostBackBreak.master" AutoEventWireup="true" CodeFile="m_ATT_Closed_Request.aspx.cs" Inherits="Attendance_m_ATT_Closed_Request" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        function fncChkSave() {
            ...
            if (document.getElementById('<%= this.ddlREQ_TYPE.ClientID %>').value == "010") {

                num = document.getElementById('<%= this.txtEXP_TAR_Amount.ClientID %>').value;
                if (isNaN(num)) {
                    num = "";
                ...
                return false;
                    ...
                    document.getElementById('<%= this.txtEXP_TAR_Amount.ClientID %>').value = num;
                }
            }
            else {
    ...
    <div class="title">
        <h2 class="mepm_title">휴무 신청서 작성</h2>
    </div>
    <article style="padding-bottom: 1em;">
        <section>
                 ...
                 <table>
                     <tr style="height: 3em;">
                         ...
                         <td style="text-align: left; padding-right:.5em;">
                             <asp:DropDownList ID="ddlREQ_TYPE" runat="server" CssClass="i_f_out" AutoPostBack="true" 
                                DataTextField="COD_Full_Name" DataValueField="COD_CD" Width="100%" OnSelectedIndexChanged="ddlREQ_TYPE_SelectedIndexChanged">
                            </asp:DropDownList>
                         </td>
                     </tr>
                 </table>
            ...
            <!-- 추가 항목 시작 -->
            <div id="ExpendReq" runat="server" class="mepm_menu_item" style="padding: 0;">
                <table class="mepm_icon_title" style="background-color:#fff;">
                    <tr>
                        <td style="width: 100%;">
                            <p>추가 입력 사항</p>
                        </td>
                ...
                <table>
                    <tr class="mepm_menu_title_bg" style="height: 3em;">
                        <td style="width: 75px; border-top: 1px solid #ccc; text-align: left; padding-left: .5em;">승인금액 :                             
                        </td>
                        <td style="width: auto; border-top: 1px solid #ccc; padding-right: .5em; text-align: left;" colspan="3">
                    ...
                    <%--<tr class="mepm_menu_title_bg" style="height: 3em;">
                        <td style="border-top: 1px solid #ccc; text-align: left; padding-left: .5em;">부가세 :                             
                        </td>
                        <td style="border-top: 1px solid #ccc; padding-right: .5em; text-align: left;" colspan="3">
                     ...
                     <tr class="mepm_menu_title_bg" style="height: 3em;">
                        <td style="border-top: 1px solid #ccc; text-align: left; padding-left: .5em;">지급대상 :                             
                        </td>
                        <td style="border-top: 1px solid #ccc; padding-right: .5em; text-align: left;" colspan="3">
                           <asp:TextBox ID="txtEXP_TAR_Res" runat="server" style="width:100%;" onfocus="this.className='i_f_on';" onblur="this.className='i_f_out'" class="i_f_out" />
                        </td>
                    </tr>
                     <tr class="mepm_menu_title_bg" style="height: 3em;">
                        <td style="border-top: 1px solid #ccc; text-align: left; padding-left: .5em;">비고 :                             
                        </td>
                        <td style="border-top: 1px solid #ccc; padding-right: .5em; text-align: left;" colspan="3">
            ...
            <div class="mepm_btn_div">
                ...
                <a href="/Attendance/m_ATT_Closed_Mng.aspx"><span class="button gray mepm_btn">취소</span></a>
            </div>            
        </section>
    </article>
</asp:Content>
