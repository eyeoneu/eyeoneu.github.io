<%@ Page Language="C#" MasterPageFile="~/m_MasterPage_PostBackBreak.master" AutoEventWireup="true" CodeFile="m_ATT_Parttime_Request_Modify.aspx.cs" Inherits="Attendance_m_ATT_Parttime_Request_Modify" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">
        <h2 class="mepm_title">근태정보 > 아르바이트 근태 목록 > 요청</h2>
    </div>
           ...
           <%--   <div ID="divAttClosed" runat="server" class="mepm_menu_title" style="padding:0; border-bottom:1px solid #ccc;">
            ...
            <div class="mepm_menu_item" style="padding:0; border-top:1px solid #ccc;">
             ...
             <div class="mepm_btn_div" style="padding:0; border-bottom:1px solid #ccc;">
                <table>
                    <tr class="mepm_menu_item_bg" style="height:3em;" runat="server" id="dvATT_DAY_Code">
