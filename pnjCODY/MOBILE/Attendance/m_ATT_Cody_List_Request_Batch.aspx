<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_ATT_Cody_List_Request_Batch.aspx.cs" Inherits="m_ATT_Cody_List_Request_Batch" %>
...
<%--    <asp:LinkButton ID="btnDetail" runat="server" OnClick="btnDetail_Click"></asp:LinkButton>--%>
    ...
    <div class="title">
        <h2 class="mepm_title">일근태 관리 > 코디 근태 일괄 요청</h2>
    </div>
        ...
        <section>
            ...
            <%--                    <asp:ListItem Text="-선택-" Value=""></asp:ListItem>--%>
                        ...
                        <td style="border-top:1px solid #ccc; padding-top:.8em;padding-right:0.5em;">
                            <asp:Button CssClass="button_nm gray mepm_btn_4em" Text="저장" ID="btnSave" runat="server" OnClientClick="javascript:return fncSave();" OnClick="btnSave_Click" />
                        </td>
                    </tr>
                     <tr  class="mepm_menu_title_bg" style="height:3.5em; border-bottom:1px solid #ccc;">
                         <td style="text-align:right;border-top:1px solid #ccc; text-align:left; padding-left:16px;" colspan="2">
                            수정사유 :
                        </td>
                        <td style="text-align:center;border-top:1px solid #ccc; text-align:left;" colspan="4">
