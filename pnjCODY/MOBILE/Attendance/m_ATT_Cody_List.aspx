<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_ATT_Cody_List.aspx.cs" Inherits="Attendance_m_ATT_Cody_List" %>
...
<META http-equiv="Cache-Control" content="No-Cache"> 
    <script type="text/javascript">
        function fncSetScroll() {
            document.getElementById('<%= this.pnlCodyAttList.ClientID %>').scrollTop = document.getElementById('<%= this.hdscrollTop.ClientID %>').value;
        }
        ...
        function fncDetail(strATT_DAY_ID, strDate) {
            ...
            document.getElementById('<%= this.hdscrollTop.ClientID %>').value = document.getElementById('<%= this.pnlCodyAttList.ClientID %>').scrollTop;
                ...
                <tr>
                    <td style="width:75%;"><p>
                        ...
                        <asp:TextBox ID="txtDate" runat="server" MaxLength="10" style="width:100px;" value="" onfocus="change_Att(this,'YYYYMMDD')" onblur="change_Att(this,'YYYYMMDD')" class="text_nm i_f_out2" Visible="false" />
                         근태 목록</p>
                    </td> <%--<a href="/Attendance/m_ATT_Cody_List.aspx">근태 목록</a></p></td>--%>
                    <td align="right">
                        <asp:Button runat="server" ID="btnBatch" Text="일괄" CssClass="button_nm gray mepm_btn_4em" OnClick="btnBatch_Click" />
                    </td>
            ...
            <div class="mepm_menu_title" style="padding:0; border-bottom:1px solid #ccc;">
                <asp:Panel ID="pnlCodyAttList" CssClass="wenitepm_div_fix_layout1" runat="server" Height="330px" Width="100%" ScrollBars="Auto">
                    <asp:GridView ID="gvCodyAttList" runat="server" CellPadding="0"  Width="100%"  EmptyDataText="등록된 정보가 없습니다." ShowHeaderWhenEmpty="True"
                            CssClass="table_border" OnRowDataBound="gvCodyAttList_RowDataBound" AutoGenerateColumns="false">
                        <Columns>
