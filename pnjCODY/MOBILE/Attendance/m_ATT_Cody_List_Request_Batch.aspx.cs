...
public partial class m_ATT_Cody_List_Request_Batch : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow rowItem in gvCodyAttList.Rows)
        {
            ...
            if (chk.Checked == true)
            {
                ...
                attendance.EPM_ATT_BY_DAY_ITEM_REQUEST_MOBILE("C", int.Parse(hdfield.Value.ToString()), "", this.ddlATT_DAY_Code.SelectedValue.ToString(), this.txtAttRequest.Text.ToString(), Session["sRES_RBS_CD"].ToString(), Session["sRES_RBS_AREA_CD"].ToString(), int.Parse(Session["sRES_ID"].ToString()));
                cnt++;
            }
        }
