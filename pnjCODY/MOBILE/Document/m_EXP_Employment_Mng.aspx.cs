...
public partial class m_EXP_Employment_Mng : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (!bError)
        {
            Common.scriptAlert(this.Page, "저장되었습니다.", "m_EXP_Employment_Mng_List.aspx?RES_ID=" + this.Page.Request["RES_ID"].ToString());
        }
    }
}