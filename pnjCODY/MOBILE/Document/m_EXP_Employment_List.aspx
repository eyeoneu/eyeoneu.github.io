<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_EXP_Employment_List.aspx.cs" Inherits="m_EXP_Employment_List" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <header>
        ...
        <p class="mepm_lg mepm_lgback">
            <a href="/"><span class="button blue">이전단계</span></a>
        </p>
    </header>
    <div class="title">
    ...
    <article style="padding-bottom: 1em;">
        <section>
            ...
            <div class="mepm_btn_div">
                <a href="/Document/m_EXP_Employment.aspx?RES_ID=<%= Session["sRES_ID"].ToString() %>&EMP_ID=0"><span class="button gray mepm_btn">입력</span></a>
