<%@ Page Language="C#" MasterPageFile="~/m_MasterPage_PostBackBreak.master" AutoEventWireup="true"  CodeFile="m_EXP_Employment_Mng.aspx.cs" Inherits="m_EXP_Employment_Mng" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <header>
        ...
        <p class="mepm_lg mepm_lgback">
            <a href="/Document/m_EXP_Employment_Mng_List.aspx?RES_ID=<%= this.Page.Request["RES_ID"]%>"><span class="button blue">이전단계</span></a></p>
    </header>
    <div class="title">
    ...
    <article style="padding-bottom: 1em;">
        <section>
            ...
            <div class="mepm_menu_item_bg" style="padding: 0;">
                <table>
                    ...
                    <tr class="mepm_menu_item_bg" style="height: 3em;">
                        ...
                        <td style="text-align: left; border-top: 1px solid #ccc; padding-right: .8em;">
                            <asp:Panel ID="pnlEmploymentList" CssClass="wenitepm_div_fix_layout1" runat="server" Height="" Width="100%" ScrollBars="none"> <!-- 항목 하나당 Height 40px +- -->
            ...
            <div class="mepm_btn_div">
                ...
                <a href="/Document/m_EXP_Employment_Mng_List.aspx?RES_ID=<%= this.Page.Request["RES_ID"]%>"><span class="button gray mepm_btn">취소</span></a>
            </div>
        </section>
    </article>
</asp:Content>
