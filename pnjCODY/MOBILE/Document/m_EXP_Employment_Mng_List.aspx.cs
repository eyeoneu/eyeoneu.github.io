...
public partial class m_EXP_Employment_Mng_List : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("/Document/m_EXP_Employment_Mng.aspx?RES_ID=" + this.Page.Request["RES_ID"] + "&EMP_ID=" + this.htEMP_ID.Value.ToString());
    }
    ...
    private DataTable Select_List()
    {
        ...
        ad.SelectCommand.Parameters.AddWithValue("@RES_ID", this.Page.Request["RES_ID"]);
