<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_NOT_WORKER_List.aspx.cs" Inherits="MOBILE_Notice_m_NOT_WORKER_List" %>
        ...
        <section>
            <table class="mepm_icon_title">
             ...
             <div class="mepm_menu_item" style="padding:0;">
                <table>
                    <tr class="mepm_menu_item_bg" style="height: 3em;">
                        ...
                        <td style="width:200px;padding-right:.5em; padding-top:.3em; padding-bottom:.3em; padding-left:.5em; text-align:left;" colspan="2">
                            <label style="margin-left: 3px;">기간:&nbsp</label>
                           <asp:TextBox ID="txtFROMDATE" width="85px" runat="server" value="YYYYMMDD" class="i_f_out" style="margin-right: 10px;"></asp:TextBox> ~ 
                           <asp:TextBox ID="txtTODATE" width="85px" runat="server" value="YYYYMMDD" class="i_f_out" style="margin-left: 10px;"></asp:TextBox>
                           <br />
                           <asp:DropDownList ID="ddl_Category" runat="server" CssClass="i_f_out" ToolTip="카테고리" style="width:90px;margin-top: 7px;"></asp:DropDownList> <%--2016-10-05 김기훈 추가--%>
                           <asp:DropDownList ID="ddlSearchGB" runat="server" CssClass="i_f_out" Width="60px" AutoPostBack="false" Enabled="true">         
                        ...
                        <td align="right" style="padding-right:0.5em; width:50px;">
                            <asp:Button CssClass="button gray mepm_btn_4em" Text="검색" ID="btnSearch" 
                                    runat="server" OnClientClick="javascript:return fncChkSearch();"  OnClick="btnSearch_Click" style="margin-right:14px;margin-top:2px;"/>
                        </td>
                    </tr>
                    </table>
                </div>
                ...
                <Columns>
                    ...
                    <asp:boundfield HeaderText="공지일" DataField="CREATED_DATE">
            ...
            <div style="height:12px"></div> 
             <div class="mepm_btn_div">
                <asp:Button CssClass="button gray_disabled mepm_asp_btn" Text="작성" ID="btnWrite" runat="server" Enabled="false" />
