<%@ Page Language="C#" MasterPageFile="~/m_MasterPage.master" AutoEventWireup="true" CodeFile="m_REP_Market_List.aspx.cs" Inherits="m_REP_Market_List" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript" language="javascript">
        // 사원 클릭 시
        function fncDetail(srtID, mktID) {
//            var parm = new Array();
...
//            location.href("/Resource/m_RES_Mng.aspx?" + encodeURI(parm.join('&')));
            ...
            document.getElementById('<%= this.htMKT_ID.ClientID %>').value = mktID;
            <%= Page.GetPostBackEventReference(this.btnDetail) %>    
        }
    </script>
    <input type="hidden" id="hdRES_ID" name="hdRES_ID" runat="server" />
    <input type="hidden" id="htMKT_ID" name="hdTrn_ID" runat="server" />
    ...
    <article style="padding-bottom: 1em;">
        <section>
            <table class="mepm_icon_title">
                    <tr>
                        <td style="width:90%;"><p >시장조사 목록</p></td>
            ...
            <div class="mepm_menu_item_bg" style="padding:0; border-bottom:1px solid #ccc;">
             ...
             <div class="mepm_menu_item" style="padding:0;">
                    <asp:GridView ID="gvMkList" runat="server" CellPadding="0"  Width="100%"  EmptyDataText="일치하는 정보가 없습니다." ShowHeaderWhenEmpty="True"
                        ...
                        <Columns>
                            <asp:boundfield HeaderText="구분" DataField="MKT_GB">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border" />
						    </asp:boundfield>
                            <asp:boundfield HeaderText="매장명" DataField="MKT_CUS">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border"/>
						    </asp:boundfield>
                            <asp:boundfield HeaderText="날짜" DataField="MKT_Date" DataFormatString="{0:d}">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border"/>
						    </asp:boundfield>
                            <asp:boundfield HeaderText="ID" DataField="MKT_ID" Visible="false">
							    <HeaderStyle CssClass="tr_border"/>
							    <ItemStyle HorizontalAlign="Center" CssClass="tr_border"/>
						    </asp:boundfield>
                        </Columns>
            ...
            <div class="mepm_btn_div">
                <a href="/Report/m_REP_Market.aspx?RES_ID=<%= this.Page.Request["RES_ID"]%>&MKT_ID=0"><span class="button gray mepm_btn">입력</span></a>
