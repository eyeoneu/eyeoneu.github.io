...
public partial class m_REP_Oil_Price : System.Web.UI.Page
{
        ...
        if (this.Page.Request["RES_ID"] != null)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(dt.Rows[0]["DRV_LITER"].ToString()))
                {
                    ...
                    hdLiter.Value = dt.Rows[0]["DRV_LITER"].ToString();
                }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlCommand CmdRemark = new SqlCommand("EPM_DAILY_OIL_CAHARGE_INSERT", Con);
            ...
            CmdRemark.Parameters.AddWithValue("@TYPE", ddlOilSelector.SelectedValue);
            CmdRemark.Parameters.AddWithValue("@LITER", hdLiter.Value);
            CmdRemark.Parameters.AddWithValue("@PRICE", txtPrice.Text);
            CmdRemark.Parameters.AddWithValue("@SUM", txtSum.Text);
