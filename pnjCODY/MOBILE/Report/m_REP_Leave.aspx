<%@ Page Language="C#" MasterPageFile="~/m_MasterPage_PostBackBreak.master" AutoEventWireup="true"  CodeFile="m_REP_Leave.aspx.cs" Inherits="m_REP_Leave" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript">
        function fncChkSave() {
            ...
            if (document.getElementById('<%=this.txtBefore.ClientID %>').value > document.getElementById('<%=this.txtMile.ClientID %>').value) {
                alert("후(퇴근)은 전(출근) 보다 적을 수 없습니다");
                document.getElementById('<%=this.txtMile.ClientID %>').focus();
                return false;
            }
         }
    ...
    <div class="title">
        <h2 class="mepm_title">업무 일지 > 퇴근</h2>
    </div>
    <article style="padding-bottom: 1em;">
        <section>
            <table class="mepm_icon_title">
                    <tr>
                        <td style="width:40%;">퇴근 <asp:Label ID="lblFinish" runat="server"></asp:Label></td>
                    </tr>
                </table>
                ...
                <table>
                    ...
                    <tr class="mepm_menu_item_bg" style="height:3em;">
                        ...
                        <td style="text-align:left; border-top:1px solid #ccc; padding-right:.8em;" colspan="2">
                            <asp:TextBox ID="txtBefore" runat="server" MaxLength="30" style="width:100%;" class="i_f_out" BackColor="#EEEEEE" Enabled="false" />
                        </td>
                    </tr>
                    <tr class="mepm_menu_item_bg" style="height:3em;">
                        <th style="border-top:1px solid #ccc; padding-left:2em;">후(퇴근): </th>
                        <td style="text-align:left; border-top:1px solid #ccc; padding-right:.8em;" colspan="2">
